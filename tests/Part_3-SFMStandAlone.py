...
Original file is located at
    https://colab.research.google.com/drive/1Ol3HRLWmltGvf9LeVMxmSDuHZl3yt5fG
...
def visualize(prev_container, curr_container, focal, pp):
    norm_prev_pts, norm_curr_pts, R, norm_foe, tZ = SFM.prepare_3D_data(prev_container,
                                                                        curr_container, focal, pp)
